...
function Note({}: Props) {
  return (
    <div className="">
      <Navbar />
      <div className=" mt-5 px-[15%] h-full">
        ...
        <div className=" flex items-center justify-end mt-5">
          <button className=" w-[64px] h-[56px] rounded-[28px] bg-customBg-btn-3 relative hover:scale-110 transition-all duration-150 ease-out">
            <Plus
              size={26}
